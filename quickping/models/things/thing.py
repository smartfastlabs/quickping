...
class Thing(Base, SingletonPerId, metaclass=AttributesMeta):
    ...
    def was_on(self, *args, **kwargs) -> Comparer:
        return self.state.was(self._on_state, *args, **kwargs)

    def was_not_on(self, *args, **kwargs) -> Comparer:
    ...
    def was_off(self, *args, **kwargs) -> Comparer:
        return self.state.was(self._off_state, *args, **kwargs)

    def was_not_off(self, *args, **kwargs) -> Comparer:
